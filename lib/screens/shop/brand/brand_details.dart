...
class BrandDetails extends StatefulWidget {
  ...
  @override
  BrandDetailsState createState() => BrandDetailsState();
}

class BrandDetailsState extends State<BrandDetails> {
  var _isInit = true;
                                  ...
                                  child: Table(
                                    ...
                                    children: [
                                      TableRow(children: [
                                        ...
                                        tableTextRight(_brandDetails!.name),
                                      ]),
                                      TableRow(children: [
                                        tableTextLeft(TITLE_DESCRIPTION),
                                        tableTextRight(
                                            _brandDetails!.description != null
                                                ? _brandDetails!.description!
                                                : '')
                                      ]),
                                      TableRow(children: [
                                        tableTextLeft(TITLE_STATUS),
                                        tableTextRight(_brandDetails!.status),
                                      ]),
                                    ],
                                  ),
                                ),
